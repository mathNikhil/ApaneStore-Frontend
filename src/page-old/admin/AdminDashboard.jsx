        ...
        <div style={styles.container}>
            ...
            <div style={styles.main}>
                ...
                <div style={styles.statsGrid}>
                    <div style={styles.statCard} onClick={() => navigate('/admin/tenants')}>
                    ...
                    <div style={styles.statCard} onClick={() => navigate('/admin/stores')}>
                ...
                <div style={styles.quickActions}>
                    ...
                    <div style={styles.actionsGrid}>
                        <button style={styles.actionBtn} onClick={() => navigate('/admin/tenants')}>
                            <span style={{fontSize:'28px',display:'block'}}>👥</span>
                            View Tenants
                        </button>
                        <button style={styles.actionBtn} onClick={() => navigate('/admin/stores')}>
                            <span style={{fontSize:'28px',display:'block'}}>🏪</span>
                            View Stores
                        </button>
                    </div>
