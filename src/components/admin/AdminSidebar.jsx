    ...
    return (
        <div style={styles.sidebar}>
            ...
            <nav style={styles.nav}>
                <Link to="/admin/dashboard" style={{...styles.navLink, ...styles[isActive('/admin/dashboard')]}}>
                    <span style={styles.icon}>📊</span>
                    <span>Dashboard</span>
                </Link>
                <Link to="/admin/tenants" style={{...styles.navLink, ...styles[isActive('/admin/tenants')]}}>
                    <span style={styles.icon}>👥</span>
                    <span>Tenants</span>
                </Link>
                <Link to="/admin/stores" style={{...styles.navLink, ...styles[isActive('/admin/stores')]}}>
                    <span style={styles.icon}>🏪</span>
                    <span>Stores</span>
                </Link>
            </nav>
