                            ...
                            <tbody>
                                {filteredStores.map(store => {
                                    ...
                                    return (
                                        <tr key={store.id}>
                                            <td>
                                                <a style={styles.link} onClick={() => navigate(`/admin/stores/${store.id}`)}>
                                                    {store.store_name}
                                                </a>
                                            </td>
                                            <td>
                                                <a style={styles.link} onClick={() => navigate(`/admin/tenants/${store.tenant_id}`)}>
                                                    {store.tenant_name}
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                <button style={styles.btnPrimary} onClick={() => navigate(`/admin/stores/${store.id}`)}>
                                                    Configure
                                                </button>
                                            </td>
                                        </tr>
